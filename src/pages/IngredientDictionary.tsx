...
const IngredientDictionary = () => {
  ...
  const [placeholderIngredient, setPlaceholderIngredient] = useState<string>("");

  useEffect(() => {
    const names = ingredientDatabase.map((i) => i.name);
    setPlaceholderIngredient(names[Math.floor(Math.random() * names.length)] || "원재료");
  }, []);
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
          <div className="relative">
            ...
            <input
              ...
              placeholder={`원재료명을 입력하세요. (예: ${placeholderIngredient})`}
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <span className="inline-block px-3 py-1 bg-blue-100 text-blue-800 text-sm rounded-full mt-2">{ingredient.category}</span>
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {ingredient.healthInfo && (
                    <div>
                      ...
                      <div className="text-green-700 bg-green-50 p-3 rounded-lg">{ingredient.healthInfo}</div>
                    </div>
                  )}
                  ...
                  {ingredient.allergyInfo && (
                    <div>
                      ...
                      <div className="text-red-700 bg-red-50 p-3 rounded-lg">{ingredient.allergyInfo}</div>
                    </div>
                  )}
                </div>
              </div>
