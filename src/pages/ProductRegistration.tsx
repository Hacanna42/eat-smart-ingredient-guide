...
const ProductRegistration = () => {
  ...
  const categories = ["음료", "과자/스낵", "유제품", "육류/어류", "곡물/시리얼", "과일/채소", "냉동식품", "건강식품", "조미료/소스", "기타"];
        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
              ...
              {formData.image && <p className="text-sm text-green-600 mt-2">선택된 파일: {formData.image.name}</p>}
            </div>
          </div>
